...
input2_worked: db "Input 2 is good!", 10, 0
...
hourly_input: db "Please enter the hourly pay rate for this employee:", 10, 0

time_input: db "Please enter the hours worked this week:", 10, 0
...
get_time_card:
    ...
    mov rdi, keyInput1
    call atof
    movsd xmm15, xmm0 ; input1 moved to xmm15
    ...
    mov rdi, keyInput2
    call atof
    movsd xmm14, xmm0 ; input2 moved to xmm14
